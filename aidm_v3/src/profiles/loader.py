...
class NarrativeProfile:
    ...
    director_personality: str | None = None

    # Tone settings (darkness, comedy, optimism)
    tone: dict[str, int] | None = None

    # Series detection for disambiguation and lore sharing
    series_group: str | None = None
    series_position: int | None = None
    series_parent: str | None = None  # Inherit lore from this profile

    # Full profile path for deep lookup
    full_profile_path: str | None = None
    ...
    detected_genres: list[str] | None = None
    ...
    author_voice: dict[str, Any] | None = None
...
def get_series_disambiguation(profile_id: str) -> list[dict[str, Any]] | None:
    """
...
def get_series_parent_profile(profile_id: str) -> dict[str, Any] | None:
    """
