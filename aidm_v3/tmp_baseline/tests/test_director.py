...
from src.db.models import Session, CampaignBible, WorldState
...
async def test_director_session_review():
    ...
    print(f"✓ Created mock CampaignBible")
    ...
    print(f"✓ Created mock WorldState")
    
    # 5. Initialize Director
    director = DirectorAgent()
    print(f"✓ Director initialized")
...
async def test_director_with_custom_personality():
    ...
    try:
        ...
        if profile.director_personality:
            print(f"✓ Profile has custom director_personality:")
            print(f"  {profile.director_personality[:100]}...")
        else:
            print(f"⚠ Profile has no custom director_personality, using default")
    except FileNotFoundError:
    ...
    try:
        ...
        print(f"✓ Director completed with custom personality")
