...
- **v3 parity audit closure — SHIPPED 2026-04-21.** All 7 phases from `docs/plans/v3-audit-closure.md` landed and pushed. Full stack: Phase 1 cheap BLOCKERs (37bceff + f1b2ee2), Phase 2 rule library (4cb88bf + 2b44b06 + b325386), Phase 3 context blocks (3c2cdb7 + 7108a24 + c87afac + 053a012), Phase 4 memory governance (63e930f), Phase 5 meta conversation (f634062 + 787abec), Phase 6 transient NPCs + WB reshape (5e81668 + 792de89), Phase 7 polish (64b9d76). Migrations 0004-0008 applied to prod. 420 tests passing at the time. See `docs/audits/v3-parity-2026-04-21.md` for original findings and per-commit audit verdicts (all CLEAN after follow-up fixes where needed). Phase 8 (M4-gated items — semantic retrieval runtime, portrait resolver, research-phase round cap eval, context-blocks session-start auto-gen reshape) tracked in the closure plan for when M4 lands.
